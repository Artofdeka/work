...
var myColor = document.getElementById("aodcolor");
...
var colorArray = ["aod-color-white","aod-color-blue","aod_color_darkyellow","aod-color-cyan",
					  "aod-color-yellow","aod-color-orange"];
...
function changeColor() {
	...
	myColor.setAttribute("class",colorArray[colorIndex]);
